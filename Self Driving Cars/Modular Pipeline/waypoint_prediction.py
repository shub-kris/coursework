...
def waypoint_prediction(
    ...
    if way_type == "center":
        ...
        tempx = 0.5 * (
            lane_boundary1_points_points[0] + lane_boundary2_points_points[0]
        )
        tempy = 0.5 * (
            lane_boundary1_points_points[1] + lane_boundary2_points_points[1]
        )
        ...
        # optimization
        way_points = minimize(
            smoothing_objective, (way_points_center), args=way_points_center
        )["x"]
